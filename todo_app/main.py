...
user_prompt = "Enter todo:"  # This is a prompt for the user to enter a todo item.
user_text = input(user_prompt)  # Get user input for the todo item
...
print(f"Todo added: {user_text}")  # Output the added todo item